...
#set_property PACKAGE_PIN P3 [get_ports {sum[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum[12]}]
#set_property PACKAGE_PIN N3 [get_ports {sum[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum[13]}]
#set_property PACKAGE_PIN P1 [get_ports {sum[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum[14]}]
#set_property PACKAGE_PIN L1 [get_ports {c_out}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {c_out}]
	
	
##7 sum_oment display
#set_property PACKAGE_PIN W7 [get_ports {sum_o[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[0]}]
#set_property PACKAGE_PIN W6 [get_ports {sum_o[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[1]}]
#set_property PACKAGE_PIN U8 [get_ports {sum_o[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[2]}]
#set_property PACKAGE_PIN V8 [get_ports {sum_o[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[3]}]
#set_property PACKAGE_PIN U5 [get_ports {sum_o[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[4]}]
#set_property PACKAGE_PIN V5 [get_ports {sum_o[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[5]}]
#set_property PACKAGE_PIN U7 [get_ports {sum_o[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sum_o[6]}]
...
#set_property PACKAGE_PIN W19 [get_ports c_in]						
	#set_property IOSTANDARD LVCMOS33 [get_ports c_in]
